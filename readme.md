...
1) Внимание эволюционирует по слоям: ранние слои показывают разнообразное внимание, поздние - сильно специализированное

2) Разнообразие голов падает с глубиной: от 0.329 в слое 0 до 0.008 в слое 8, что указывает на усиление специализации

3) Модель адаптирует стратегию внимания под класс объекта:

- Pullover: сфокусированное внимание (Coverage=0.168)

- Trouser: распределенное внимание (Coverage=0.301)

4) Архитектура устойчива к изменению разрешения - механизм внимания сохраняет работоспособность при разных размерах изображения

5) Наиболее сбалансированное внимание в средних слоях (3-6), что делает их оптимальными для интерпретации
