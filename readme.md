...
## Выводы
    ...
    Внимание эволюционирует по слоям: ранние слои показывают разнообразное внимание, поздние - сильно специализированное

    Разнообразие голов падает с глубиной: от 0.329 в слое 0 до 0.008 в слое 8, что указывает на усиление специализации

    Модель адаптирует стратегию внимания под класс объекта:

        Pullover: сфокусированное внимание (Coverage=0.168)

        Trouser: распределенное внимание (Coverage=0.301)

    Архитектура устойчива к изменению разрешения - механизм внимания сохраняет работоспособность при разных размерах изображения

    Наиболее сбалансированное внимание в средних слоях (3-6), что делает их оптимальными для интерпретации
